...
public class SelectionEntry<T> {
     ...
     */
    public SelectionEntry(T value, boolean allowNullValues) {
        this.allowNullValues = allowNullValues;
        this.value = allowNullValues ? value : Preconditions.checkNotNull(value, "Value in the target SelectionEntry may not be null.");
    }
