...
public class PreArenaEndEvent extends ArenaEndEvent {

    private final ImmutableList<MatchPlayer> trackedPlayers;
    private final GameSummary gameSummary;

    public PreArenaEndEvent(MatchArena arena, boolean forcibly, ImmutableList<MatchPlayer> trackedPlayers, GameSummary gameSummary) {
